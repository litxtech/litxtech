...
export function NoctaAppAccountDeletion() {
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <SeoHead
        title="Nocta Hesap Silme | LitxTech"
        description="Nocta hesabınızı uygulama içinden veya e-posta ile nasıl silebileceğiniz."
        path="/nocta/hesap-silme"
      />
      <div className="mx-auto max-w-4xl space-y-12 px-6 py-16">
        <header className="space-y-4">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-indigo-600">Nocta · LitxTech</p>
          <h1 className="text-4xl font-bold">Hesabınızı silme</h1>
          <p className="text-lg text-gray-600">
            Nocta hesabınızı kalıcı olarak kapatmak için uygulama içi yolu kullanmanız tercih edilir. Uygulamaya erişemiyorsanız aşağıdaki e-posta
            yöntemiyle talepte bulunabilirsiniz.
          </p>
        </header>

        <section className="space-y-6 rounded-3xl border border-gray-200 bg-gray-50 p-6">
          <div className="flex items-center gap-3">
            <Smartphone className="h-8 w-8 shrink-0 text-indigo-600" />
            <h2 className="text-2xl font-semibold">Uygulama üzerinden silme</h2>
          </div>
          <ol className="list-decimal space-y-3 pl-6 text-gray-700">
            <li>Nocta uygulamasını cihazınızda açın.</li>
            <li>
        ...
        <section className="space-y-6 rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-3">
            <Mail className="h-8 w-8 shrink-0 text-indigo-600" />
          ...
          <ul className="list-disc space-y-2 pl-6 text-gray-700">
            ...
            <li>
              Konu: <strong>Nocta Hesap Silme</strong>
            </li>
        ...
        <section className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-4 rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <p className="text-gray-700">
              Uygulama içi silme işlemleri genellikle kısa sürede tamamlanır. E-posta talepleri kimlik doğrulamasından sonra işlenir; yoğunluğa göre
              birkaç iş günü sürebilir.
            </p>
          </div>
        </section>

        <section className="flex items-start gap-3 rounded-2xl border border-indigo-100 bg-indigo-50/80 p-5">
          <Shield className="mt-0.5 h-6 w-6 shrink-0 text-indigo-600" />
          <p className="text-sm text-gray-700">
            Kişisel veri haklarınız için{' '}
            <Link to="/nocta/gizlilik" className="font-semibold text-indigo-600 underline">
              Gizlilik Politikası
            </Link>{' '}
            bölümüne bakın.
          </p>
