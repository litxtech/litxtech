...
export function KbsPrimeTerms() {
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <div className="max-w-3xl mx-auto px-6 py-12 space-y-8">
        <header className="space-y-2 border-b border-gray-200 pb-6">
          <p className="text-sm font-semibold tracking-wide text-red-600 uppercase">Terms</p>
          ...
          <p>
            ...
            This document explains what information we collect, how it is used, and how it is protected.
          </p>
        </header>
        ...
        <div className="pt-6 border-t border-gray-200 flex gap-4">
          ...
          <Link to="/kbs-prime-privacy" className="text-blue-600 hover:text-blue-800 font-medium">KBS Prime Privacy</Link>
        </div>
      </div>
    </div>
  )
