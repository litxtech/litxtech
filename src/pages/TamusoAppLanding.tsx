          ...
          >
            ...
            <p className="mx-auto max-w-xl text-lg text-zinc-300 sm:text-xl">
             ...
             <div className="flex flex-wrap justify-center gap-4">
               <div className="inline-flex h-14 items-center rounded-2xl bg-black px-6 py-3 font-semibold text-white shadow-xl ring-1 ring-white/15">
                <svg className="mr-2 h-8 w-8" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                 ...
                 <span className="text-left leading-tight">
                   <span className="block text-[10px] font-normal text-zinc-400">Yakında</span>
                   App Store
                 </span>
               </div>
               <div className="inline-flex h-14 items-center rounded-2xl border border-white/20 bg-white/5 px-6 py-3 font-semibold text-white backdrop-blur">
             ...
             <p className="text-xs text-zinc-500">Mağaza bağlantıları yayımlandığında butonlar güncellenecektir.</p>
          </motion.div>
